import { FRAGMENT_COLOR, NORMAL, VERTEX_POINT } from "../../../..";

export const SHADER_SCHEMA_TYPES = {
  OPERATOR: "operator",
  VERTEX: "vertex",
  FRAGMENT: "fragment",
  SHADER_FUNCTION: "shaderFunction",
  SHADER_FUNCTION_VERTEX: "shaderFunctionVertex",
  SHADER_FUNCTION_FRAGMENT: "shaderFunctionFragment",
...
export const SHADER_TYPES = {
  ...
  SHADER_FUNCTION: SHADER_SCHEMA_TYPES.SHADER_FUNCTION,
  SHADER_FUNCTION_VERTEX: SHADER_SCHEMA_TYPES.SHADER_FUNCTION_VERTEX,
  SHADER_FUNCTION_FRAGMENT: SHADER_SCHEMA_TYPES.SHADER_FUNCTION_FRAGMENT,
};
...
export const SHADER_VARIABLE_ASSIGNMENT_MAPS = {
  ...
  [SHADER_SCHEMA_TYPES.SHADER_FUNCTION_VERTEX]: {
    [SHADER_VARIABLE_TYPES.VARIABLE]: null,
  },
  [SHADER_SCHEMA_TYPES.SHADER_FUNCTION_FRAGMENT]: {
    [SHADER_VARIABLE_TYPES.VARIABLE]: null,
  },
  [SHADER_SCHEMA_TYPES.SHADER_FUNCTION]: {
    [SHADER_VARIABLE_TYPES.VARIABLE]: null,
  },
};

export const SHADER_PARAMETER_TYPE_KEY_MAP = {
  [SHADER_PROPERTY_TYPES.CONSTANT]: "c",
  [SHADER_PROPERTY_TYPES.UNIFORM]: "u",
  [SHADER_PROPERTY_TYPES.VARYING]: "v",
  [SHADER_PROPERTY_TYPES.ATTRIBUTE]: "a",
};
