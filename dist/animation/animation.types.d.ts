...
import { ANIMATION_FUNCTION_TYPES, ANIMATION_TYPES, OBJECT_UPDATE_PROPERTY, TRIG_FUNCTION_TYPES } from "./animation.constants";
import { AnimationLoopConfigItem, TransitionLoopConfig } from "./animation-functions/shader-animations/animation-loop/animationloop.types";
import { Axis, Position3d } from "../utils/three-dimension-space/position/position.types";
...
export interface TrigonometricAnimationConfig extends AnimationPropertiesConfig {
    trigFunctionType: TrigFunctionType;
    objectUpdateProperty: ObjectUpdateProperty;
}
export type AnimationProperties = RotationAnimationConfig | SpinAnimationConfig | TraversalAnimationConfig | TrigonometricAnimationConfig | ShaderAnimationConfig | MoveAnimationConfig | FallAnimationConfig;
