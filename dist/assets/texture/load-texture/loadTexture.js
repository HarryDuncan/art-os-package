import { TextureLoader, MathUtils as Math, LinearFilter, RGBAFormat, } from "three";
export const loadTexture = (path) => new Promise((resolve) => {
    const textureLoader = new TextureLoader();
    textureLoader.load(path, (data) => {
        if (!Math.isPowerOfTwo(data.image.width) ||
