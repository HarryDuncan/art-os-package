...
import { DEFAULT_ISOLATION, DEFAULT_MARCHING_CUBES_SCALE, DEFAULT_RESOLUTION, } from "./marchingCubes.constants";
import { DEFAULT_MATERIAL } from "../../../config/material/materials.default";
export const MarchingCubesElement = ({ id, resolution = DEFAULT_RESOLUTION, material = DEFAULT_MATERIAL, isolation = DEFAULT_ISOLATION, scale = DEFAULT_MARCHING_CUBES_SCALE, }) => {
    const marchingCubeEffect = new ThreeJsMarchingCubes(resolution, material, true, true, 100000);
