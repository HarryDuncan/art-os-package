...
import { POINT_PARENTS, ShaderPropertyValueTypes } from "../constants/buildShader.consts";
import { VARYING_TYPES } from "../shader-properties/varyings/varyings.consts";
import { INTERACTION_VERTEX_EFFECT, TransformTypes } from "../vertex-effects/vertexEffects.consts";
import { FragmentEffectConfig, InteractiveFragmentEffect, TriggeredFragmentEffect } from "./fragmentShader.types";
import { DisplacementType, InteractiveVertexEffectProps, TriggeredVertexEffect, VertexEffectProps } from "./vertexShader.types";
...
export type TriggeredEffectProps = TriggeredFragmentEffect | TriggeredVertexEffect;
export type InteractiveEffectProps = InteractiveFragmentEffect | InteractiveVertexEffect;
...
export type StructConfig = {
    id: string;
    properties: ShaderPropertyConfig[];
};
