...
import { DISPLACEMENT_TYPES, DISTORTION_TYPES, IMAGE_VERTEX_EFFECT, TRIGGERED_VERTEX_EFFECT } from "../vertex-effects/vertexEffects.consts";
...
export type ImageSubEffectProps = ImageAsMaskEffectProps | ImageToPointsEffectProps;
type ImageSubEffect = {
...
export type TriggeredVertexEffectProps = DisplacementEffectProps | ExplodeEffectProps | ExpandEffectProps;
...
export type InteractiveVertexEffectProps = DisplacementEffectProps | ExplodeEffectProps;
export type VertexEffectProps = RotationEffectProps | DisplacementEffectProps | MorphEffectProps | PointsEffectProps | InteractiveVertexEffectProps | ExpandEffectProps | NoiseEffectProps | ExplodeEffectProps | ImageVertexEffect | ImageToPointsEffectProps | TriggeredVertexEffect;
export {};
