import { FRAGMENT_EFFECT, INTERACTION_FRAGMENT_EFFECT, TRIGGERED_FRAGMENT_EFFECT } from "../fragment-effects/fragmentEffects.consts";
import { EffectParameters, ShaderFunction, UniformConfig, VaryingConfig, AttributeConfig, StructConfig } from "./buildShader.types";
...
export type FragmentEffectProps = PointMaterialFragmentEffectProps | ColorFragmentEffectProps | OpacityFragmentEffectProps | VanishFragmentEffectProps | TriggeredFragmentEffect | MaterialEffectProps | InteractiveFragmentEffect | BrightnessFragmentEffectProps;
...
export type TriggeredFragmentEffectProps = PointColorFragmentEffectProps | OpacityFragmentEffectProps;
