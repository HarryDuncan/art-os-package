...
export const vanishTransform = (vanishParameters) => {
    ...
    const transformation = `
        ...
        vec3 col = vec3(simplePerlinNoise(vec3(1.0 - newPosition.z * ${numberOfRings ? shaderSafeFloat(numberOfRings) : "uNumberOfRings"})) * 0.0)  * ${FRAG_COLOR_NAME}.xyz * brightness;
