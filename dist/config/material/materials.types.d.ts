...
import { ENV_MAP_TYPES, MATERIAL_TYPES } from "./materials.consts";
...
export type MaterialConfigProps = MatcapMaterialProps | ShaderMaterialProps | VideoMaterialProps | EnvMapMaterialProps;
