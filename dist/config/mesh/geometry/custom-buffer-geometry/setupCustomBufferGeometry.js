...
export const setUpCustomBufferGeometry = (bufferGeometryType, _bufferGeometryConfig) => {
...
const setUpQuad = () => {
    ...
    // index
    bufferGeometry.setIndex(new BufferAttribute(new Uint16Array([0, 2, 1, 2, 3, 1]), 1));
