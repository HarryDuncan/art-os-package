...
const useThreadWithPostProcessor = (currentFrameRef, camera, renderer, passes) => {
    ...
    const update = (0, react_1.useCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const { Pass } = yield Promise.resolve().then(() => __importStar(require("three/examples/jsm/postprocessing/Pass.js")));
